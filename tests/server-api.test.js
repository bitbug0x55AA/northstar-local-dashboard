...
test.before(async () => {
  ...
  fs.writeFileSync(path.join(codexUsagePath, 'session.jsonl'), `${JSON.stringify({ timestamp: now, type: 'event_msg', payload: { session_id: 'codex-session', model: 'gpt-5-codex', info: { last_token_usage: { total_tokens: 180000, input_tokens: 180000 } } } })}\n`);
