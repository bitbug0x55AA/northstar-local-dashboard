(function () {
  ...
  const ruleDocs = {
    'USAGE-QUOTA-50': { title: 'Codex / Claude quota at 50%', meaning: 'The local usage importer found that a hosted coding assistant has consumed at least half of its observed quota window. This is an early capacity warning, not a security incident or a local LLM failure.', action: 'Keep the reset time in mind and avoid unnecessary long sessions if you expect heavier work.' },
    ...
    'USAGE-QUOTA-90': { title: 'Codex / Claude quota at 90%', meaning: 'The hosted coding assistant is close to its observed quota limit. Long tasks may be throttled, delayed, or unavailable until reset.', action: 'Save work, avoid large exploratory runs, and check the provider reset time before continuing.' },
